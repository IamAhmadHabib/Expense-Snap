...
class _AuthScreenState extends State<AuthScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final logoFade = _getStaggerAnim(
      0.0,
      0.3,
    ); // Map to the last 30% of global t
  ...
  Widget _buildSocialButton({
    ...
    final backgroundColor =
        customBgColor ?? (isOutlined ? Colors.transparent : AppColors.surface);
            ...
            child: Row(
              ...
              children: [
                if (logo != null)
                  ...
                  Icon(icon, color: foregroundColor, size: isSmall ? 20 : 24),
