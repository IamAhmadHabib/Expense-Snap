...
class _OnboardingScreenState extends State<OnboardingScreen>
  ...
  final List<_OnboardingPage> _pages = const [
    _OnboardingPage(
      ...
      subtitle:
          'Speak, scan, or type — log expenses\nthe way you naturally think',
    ...
    return Padding(
      ...
      child: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final illustrationRatio = pageHeight < 560 ? 0.58 : 0.64;
          final illustrationHeight = (pageHeight * illustrationRatio).clamp(
            240.0,
            452.0,
          );
          final textTopGap = pageHeight < 620 ? AppSpacing.md : AppSpacing.xl;
