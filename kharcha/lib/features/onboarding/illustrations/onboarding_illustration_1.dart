    ...
    return SizedBox(
      ...
      child: Stack(
        ...
        children: [
          ...
          Positioned(top: 20, child: _buildPhone()),
      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            child: Icon(Icons.mic_rounded, color: AppColors.accent, size: 26),
          ),
...
class _SoundWavePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 0; i < 6; i++) {
      ...
      final opacity = (0.55 - (i * 0.07)).clamp(
        0.08,
        0.55,
      ); // Higher opacity to be clearly visible
...
class _WaveformPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 0; i < barCount; i++) {
      ...
      final wave = math.sin(normalizedI * math.pi * 4 + progress * math.pi * 2);
